    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-muted">
      <div className="container mx-auto">
        ...
        <div className="flex justify-center space-x-6 mb-8">
          ...
          <Button variant="outline" size="icon" asChild>
            <a href="https://www.linkedin.com/in/mohamad-rafli-agung-subekti-640a77285/" target="_blank" rel="noopener noreferrer">
          ...
          {/* Tombol Email */}
          <Button variant="outline" size="icon" asChild>
            <a href="mailto:raflisbk@gmail.com" target="_blank" rel="noopener noreferrer">
